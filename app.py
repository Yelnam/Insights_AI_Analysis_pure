...
from utils.dicts_data_analysis import dict_brand_brands, dict_brand_brands_2, dict_brand_prompt, dict_model_costs
...
from utils.func_data import (search_brand, brand_consolidator, assign_prominence, assign_prominence_no_paras, noopsis_replicator, cost_calculator, val_counts_try_except, get_author_top_source, 
...
def index():
    ...
    return render_template('index_mod3.html')  
